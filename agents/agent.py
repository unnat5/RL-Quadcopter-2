...
class DDPG1():
    ...
    def __init__(self, task):
        ...
        self.actor_local.model.load_weights('my_actor_local_weights.h5',by_name=True)
...
#@@@@0.99  # discount factor
    ...
    def learn(self, experiences):
        ...
        if self.score > self.best_score:
            ...
            #self.critic_local.model.save_weights('my_critic_model_weights.h5')
            #self.actor_local.model.save_weights('my_actor_model_weights.h5')
            self.actor_local.model.save_weights('my_actor_local_weights.h5')
